...
{
    public Task CreateOne(ProgressEntity progress);
    public Task<ProgressEntity> FindOneByUserId(string userId);
    public Task<ProgressEntity> UpdateOne(ProgressEntity progress);
}
